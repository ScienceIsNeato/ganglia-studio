...
def get_audio_duration(audio_file_path: str) -> float | None:
...
def get_video_duration(video_file_path: str) -> float | None:
...
def find_final_video(output_dir: str) -> str | None:
...
def parse_ttv_output_for_dir(output_log: str) -> str | None:
